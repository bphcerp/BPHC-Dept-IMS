...
<head>
    <meta charset="UTF-8">
    <title>Format for Evaluation of Research Proposals</title>
    <style>
        ...
        .checkbox-row { margin-left: 20px; margin-bottom: 10px; }
        textarea { width: 100%; height: 60px; border: 1px solid #ccc; padding: 5px; }
    </style>
</head>
<body>
    ...
    <div class="section">
        ...
        <div class="checkbox-row">d) Does the proposed topic aim at:<br>
            &nbsp;&nbsp; ${tickEnum(
                formData.q1d,
                "product"
            )} designing an innovative product<br>
            &nbsp;&nbsp; ${tickEnum(
                formData.q1d,
                "process"
            )} designing a new process or a system<br>
            &nbsp;&nbsp; ${tickEnum(
                formData.q1d,
                "frontier"
    ...
    <div class="section">
        ...
        <div class="checkbox-row">d) The outcome of the work: <br>
            &nbsp;&nbsp; ${tickEnum(
                formData.q2d,
                "improve"
            )} will improve the present state of art<br>
            &nbsp;&nbsp; ${tickEnum(
                formData.q2d,
                "academic"
    ...
    <div class="section">
        ...
        <div class="checkbox-row">
            ...
            ${tickEnum(
                formData.q6,
                "minor"
            )} Proposal needs minor modifications<br>
