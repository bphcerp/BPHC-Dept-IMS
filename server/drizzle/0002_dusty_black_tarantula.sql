...
ALTER TABLE "qp_review_requests" ADD CONSTRAINT "qp_review_requests_created_at_date_fields_id_fk" FOREIGN KEY ("created_at") REFERENCES "public"."date_fields"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
