ALTER TABLE "qp_review_requests" RENAME COLUMN "fic_email" TO "ic_email";--> statement-breakpoint
ALTER TABLE "qp_review_requests" RENAME COLUMN "faculty_1_email" TO "reviewer_email";--> statement-breakpoint
ALTER TABLE "qp_review_requests" RENAME COLUMN "mid_sem_file_id" TO "mid_sem_file_path";--> statement-breakpoint
ALTER TABLE "qp_review_requests" RENAME COLUMN "mid_sem_sol_file_id" TO "mid_sem_sol_file_path";--> statement-breakpoint
ALTER TABLE "qp_review_requests" RENAME COLUMN "compre_file_id" TO "compre_file_path";--> statement-breakpoint
ALTER TABLE "qp_review_requests" RENAME COLUMN "compre_sol_file_id" TO "compre_sol_file_path";--> statement-breakpoint
ALTER TABLE "qp_review_requests" RENAME COLUMN "review_1" TO "review";--> statement-breakpoint
