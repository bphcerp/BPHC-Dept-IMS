export const allPermissions = {
    ...
    "analytics:presentation": "Manage presentations",
    "analytics:templates": "View templates",
    "analytics:templates:manage" : "Manage templates",
...
export const permissions: { [key: string]: keyof typeof allPermissions } = {
    ...
    "/conference/applications/requestAction":
        "conference:application:submitted",
