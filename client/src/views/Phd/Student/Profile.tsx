            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  ...
                  <span className="text-gray-900">
                    {student.supervisorEmail || "Not Assigned"}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  <span className="font-medium text-gray-700">
                  ...
                  <span className="text-gray-900">
                    {student.coSupervisorEmail || "Not Assigned"}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  <span className="font-medium text-gray-700">
                  ...
                  <span className="text-gray-900">
                    {student.coSupervisorEmail2 || "Not Assigned"}
                  </span>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  ...
                  <span className="text-right text-gray-900">
                    {student.dacMember1Name ? (
                      <>
                        {student.dacMember1Name}
                        <br />
                        <span className="text-xs text-muted-foreground">
                          {student.dacMember1Email}
                        </span>
                      </>
                    ) : (
                      student.dacMember1Email || "Not Assigned"
                    )}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  ...
                  <span className="text-right text-gray-900">
                    {student.dacMember2Name ? (
                      <>
                        {student.dacMember2Name}
                        <br />
                        <span className="text-xs text-muted-foreground">
                          {student.dacMember2Email}
                        </span>
                      </>
                    ) : (
                      student.dacMember2Email || "Not Assigned"
                    )}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  ...
                  <span className="text-gray-900">
                    {student.numberOfQeApplication || 0}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  <span className="font-medium text-gray-700">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  ...
                  <span className="text-gray-900">
                    {student.qualifyingArea1 || "Not Selected"}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  <span className="font-medium text-gray-700">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  ...
                  <span className="text-gray-900">
                    {student.qualifyingArea2 || "Not Selected"}
                  </span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 py-2">
                  <span className="font-medium text-gray-700">
