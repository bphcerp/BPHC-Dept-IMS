  ...
  const renderGradeInput = (
    ...
    if (fixedOptions && fixedOptions.length > 0) {
      return (
        <Select
          ...
          disabled={disabled}
        >
          <SelectTrigger className={`w-40 ${disabled ? 'bg-gray-200 text-gray-600 cursor-not-allowed' : ''}`}>
    ...
    return (
      <Input
        ...
        className={`w-40 ${disabled ? 'bg-gray-200 text-gray-600 cursor-not-allowed' : ''}`}
        readOnly={disabled}
      />
    );
  };
                                ...
                                return (
                                  <TableCell key={header.name}>
                                    {renderGradeInput(
                                      ...
                                      coursePhase === "draft" ||
                                      (coursePhase === "midsem" &&
                                        getGradeColumnRole(c, headerIndex) === "endsem") ||
                                      (coursePhase === "endsem" &&
                                        getGradeColumnRole(c, headerIndex) === "midsem"),
                                      "Enter grade"
                                    )}
                                  </TableCell>
                                );
                              ...
                              <>
                                ...
                                <TableCell>
                                  <Input
                                    ...
                                    placeholder="Marks"
                                    className={`w-28 ${coursePhase === "draft" || coursePhase === "endsem"
                                      ? 'bg-gray-200 text-gray-600 cursor-not-allowed'
                                      : ''
                                      }`}
                                    readOnly={
                                ...
                                <TableCell>
                                  {renderGradeInput(
                                    ...
                                    coursePhase === "draft" || coursePhase === "endsem",
                                    "Grade"
                                  )}
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell>
                                  <Input
                                    ...
                                    placeholder="Marks"
                                    className={`w-28 ${coursePhase === "draft" || coursePhase === "midsem"
                                      ? 'bg-gray-200 text-gray-600 cursor-not-allowed'
                                      : ''
                                      }`}
                                    readOnly={
                                ...
                                <TableCell>
                                  {renderGradeInput(
                                    ...
                                    coursePhase === "draft" || coursePhase === "midsem",
                                    "Grade"
                                  )}
                                </TableCell>
                                <TableCell>
