        ...
        <div className="mx-auto flex max-w-5xl flex-1 flex-col justify-center gap-4 p-4">
            ...
            <div className="flex items-center gap-4">
                <div className="relative">
                    ...
                    <Input type="search" placeholder="Search members..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 w-64" />
                </div>
                <Button onClick={() => void refetch()}>Search</Button>
            </div>
            {isFetching ? <LoadingSpinner /> : !members?.length ? <p>No members found</p> : <MemberList members={members} />}
