...
const handoutData: HandoutItem[] = [
  { id: 1, handoutName: "Handout 1", professorName: "Professor A", status: "Approved" },
  { id: 2, handoutName: "Handout 2", professorName: "Professor B", status: "Pending" },
  { id: 3, handoutName: "Handout 3", professorName: "Professor C", status: "Rejected" },
];
