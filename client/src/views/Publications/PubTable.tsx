...
//       header: "Link",
//       cell: (info) => {
//         return <a href={info.getValue()} className="font-bold text-blue-500">Link</a>
//       }
//     }),
...
//       cell: (info) => info.getValue(),
//     }),
//     columnHelper.accessor("citationId", {
//       header: "Citation ID",
//       cell: (info) => info.getValue(),
//     }),
//     columnHelper.accessor("authorNames", {
//       header: "Author Names",
//       cell: (info) => info.getValue(),
//     }),
//     columnHelper.accessor("coAuthors", {
//       header: "Co-Authors",
//       cell: (info) => info.getValue().map((a: CoAuthor) => a.authorId).join(", "),
//     }),
//   ],
//   []
// );
...
const columns: ColumnDef<Publication>[] = [
  ...
  },
  {
    ...
    header: "Co-Authors",
    cell: (info) =>
      (info.getValue() as { authorId: string }[])
        .map((a) => a.authorId)
        .join(", "),
  },
];
