      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <FileDown className="h-5 w-5" /> Generate Forms for Verified
            Applications
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex gap-3">
            <Button
              ...
              disabled={
                selectedApplications.length === 0 || isDownloading || isPrinting
              }
            ...
            <Button
              ...
              disabled={
                selectedApplications.length === 0 || isPrinting || isDownloading
              }
              className="flex items-center gap-2"
            >
              ...
              <TableHeader>
                <TableRow>
                  <TableHead className="w-12">
                    <Checkbox
                      checked={
                        selectedApplications.length === verifiedApps.length &&
                        verifiedApps.length > 0
                      }
          ...
          <CardContent className="py-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                No applications have been verified yet in the
                &quot;Applications&quot; tab.
              </p>
            </div>
          </CardContent>
